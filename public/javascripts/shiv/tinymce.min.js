...
!(function () {
  ...
  const qo = '\ufeff',
    ...
    Sr =
      ('data-mce-bookmark', (e) => er(e) && e.hasAttribute('data-mce-bookmark'))
  const Nr = (e, t, n, o) =>
      dr(e) &&
      !((e, t, n) =>
        Go(e.data) &&
    ...
    Uu = (e, t) => {
      ...
      return dr(n)
        ...
        : n
          ? Bi(n)
            ? I.some(
                e ? Qi.before(n) : pr((o = n)) ? Qi.before(o) : Qi.after(o),
              )
            : ((e, t, n) => {
              ...
              ? o.hasChildNodes()
                ...
                : em(o.nextSibling)
                  ...
                  : em(o.previousSibling)
                    ? ((a = o.previousSibling),
                      (i = o.previousSibling.data.length))
                    ...
                    h.stopImmediatePropagation(),
                      ...
                      ((h) => {
                        ...
                        ;(u = h.screenX),
                          ...
                          (i = ((e, t) => {
                            if (E(t))
                              return e.create('img', { src: Tt.transparentSrc })
                            if (ar(t)) {
        ...
        e
          ? ((e, t) =>
              wh(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    zu(e, Qi.after(t)).orThunk(() => ju(e, Qi.before(t))))(
                    e,
                    t,
                  ),
                ))(t, n)
                ...
                .bind((e) => {
                  ...
                  if (r.length > 0) {
                    if (o) return I.some(Vh.partialTable(r, I.none()))
                    {
                      const e = Qh(n, t)
                      return I.some(
                        Vh.partialTable(r, I.some({ ...t, rng: e })),
                      )
                    }
                  }
                  return I.none()
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                zb(
                  ...
                  (n) =>
                    ue(t, (t) =>
                      ((t, n) => (Wb(e, t.dom, n) ? I.some(n) : I.none()))(
                        n,
                        t,
                      ),
                    ),
        ...
        ((e) => {
          e.on('mouseup keydown', (t) => {
            ...
            ;((e, t, n) => {
              ...
              e,
              t.keyCode,
              ((n = e.selection.getRng().endContainer),
              dr(n) && Ve(n.data, Wo)),
            )
          })
        })(e),
                      ...
                      : ((e, t, n, o) =>
                          ((e, t) => {
                            const n = t.getNode(!e),
                              o = e ? 'after' : 'before'
                            return (
                              er(n) && n.getAttribute('data-mce-caret') === o
                            )
                          })(t, n)
                            ? ((e, t) =>
                                y(t)
                                  ...
                                  : e && vr(t.nextSibling)
                                    ...
                                    : !e && vr(t.previousSibling)
                                      ? I.some(
                                          jx.moveToElement(t.previousSibling),
                                        )
              ...
              t.startDetails.exists((n) =>
                ju(n, e).forall((n) =>
                  t.startSummary.exists(
                    (t) =>
                      !t.contains(e.container()) && t.contains(n.container()),
                  ),
                ),
              ))(s, t)
    },
