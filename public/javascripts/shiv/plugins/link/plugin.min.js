...
!(function () {
  ...
  const M = (e) => (o(e.value) ? e.value : ''),
    ...
    I = (e) => B(M)(e),
    K = B,
    j = (e, t) => (n) => ({ name: e, type: 'listbox', label: t, items: n }),
    U = M,
    q = Object.keys,
  ...
  const G = (e) => s(e) && 'a' === e.nodeName.toLowerCase(),
    ...
    se = (e, t, n) => {
      ...
      e.hasPlugin('rtc', !0)
        ? e.execCommand('createlink', !1, ae(o))
        : ie(e, t, o)
    },
    ce = (e) => {
      e.hasPlugin('rtc', !0)
              ...
              le(t)
                ...
                : ((e) => {
                    const t = e.dom,
                      ...
                      i = t.getParent(r.endContainer, 'a[href]', e.getBody())
    ...
    me = (e, t) => {
      const n = { text: e.text, title: e.title },
        o = (e, o) => {
          const r = ((l = t),
          (i = o),
          'link' === i ? l.link : 'anchor' === i ? l.anchor : m.none()).getOr(
            [],
          )
          var l, i
          return ((e, t, n, o) => {
          ...
          return {
            ...
            body: {
              ...
              items: p([
                ...
                r,
                x([
                  i.anchor.map(j('anchor', 'Anchors')),
                  i.rels.map(j('rel', 'Rel')),
                  i.targets.map(j('target', 'Open link in...')),
                  i.link.map(j('link', 'Link list')),
                  i.classes.map(j('linkClass', 'Class')),
                ]),
              ]),
            },
            buttons: [
