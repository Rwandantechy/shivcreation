...
!(function () {
  ...
  const y = Array.prototype.push,
    ...
    V = (e) => void 0 !== e.style && m(e.style.getPropertyValue),
    j = (e) => {
    ...
    z = (e) => B(e.dom.ownerDocument),
    $ = (e) => S(e.dom.childNodes, B),
    U = m(Element.prototype.attachShadow) && m(Node.prototype.getRootNode),
    K = p(U),
    X = U ? (e) => B(e.dom.getRootNode()) : (e) => (N(e) ? e : z(e)),
    Y = (e) => {
      const t = X(e)
      return H((n = t)) && d(n.dom.host) ? b.some(t) : b.none()
      var n
    },
    G = (e) => B(e.dom.host),
    J = (e) => {
    ...
    te = (e, t) => {
      ...
      return '' !== r || J(e) ? r : ne(n, t)
    },
    ne = (e, t) => (V(e) ? e.style.getPropertyValue(t) : ''),
    re = (e) => {
      const t = B(
          ((e) => {
            if (K() && d(e.target)) {
              ...
              if (P(t) && d(t.dom.shadowRoot) && e.composed && e.composedPath) {
                ...
                if (t)
                  return ((e, t) => (0 < e.length ? b.some(e[0]) : b.none()))(t)
              }
            }
    ...
    ie = (e, t, n) =>
      ((e, t, n, r) =>
        ((e, t, n, r, o) => {
          ...
          return e.dom.addEventListener(t, s, o), { unbind: f(oe, e, t, s, o) }
        })(e, t, n, r, !1))(e, t, se, n),
    le = () => ae(0, 0),
    ae = (e, t) => ({ major: e, minor: t }),
    ce = {
      nu: ae,
      detect: (e, t) => {
    ...
    he = [
      ...
      },
      {
        ...
        search: (e) => I(e, 'chrome') && !I(e, 'chromeframe'),
      },
      {
        name: 'IE',
        versionRegexes: [
      ...
      },
      {
        ...
        search: (e) =>
          (I(e, 'safari') || I(e, 'mobile/')) && I(e, 'applewebkit'),
      },
    ],
    ge = [
      {
    ...
    xe = () => Se({ current: void 0, version: ce.unknown() }),
    Ee = Se,
    Fe = (p(fe), p(ve), p('IE'), p(we), p(be), p(ye), 'Windows'),
    Oe = 'Android',
    ke = 'Linux',
    Te = 'macOS',
    Ce = 'Solaris',
    ...
    Me = () => Le({ current: void 0, version: ce.unknown() }),
    Pe = Le,
    De =
      (p(Fe),
      p('iOS'),
              ...
              ((e, t) =>
                ((e, t) => {
                  ...
                  return F(e, (e) => {
                    ...
                    current: e.name,
                    version: ce.nu(parseInt(t.version, 10), 0),
                  }))
                }))(r, e),
            )
            .orThunk(() =>
              ((e, t) =>
                ue(e, t).map((e) => {
                  const n = ce.detect(e.versionRegexes, t)
    ...
    Ne = (e) => window.matchMedia(e).matches
  let He = ((e) => {
    let t,
      n = !1
    return (...r) => (n || ((n = !0), (t = e.apply(null, r))), t)
  })(() => De(navigator.userAgent, b.from(navigator.userAgentData), Ne))
  const We = (e, t) => ({
      left: e,
      top: t,
      translate: (n, r) => We(e + n, t + r),
    }),
    qe = We,
    Ie = (e) => {
      const t = void 0 === e ? window : e
      return He().browser.isFirefox() ? b.none() : b.from(t.visualViewport)
    },
    Ve = (e, t, n, r) => ({
      x: e,
      y: t,
    ...
    Be = (e, t, n) =>
      Ie(n)
        ...
        .getOrThunk(() => ({ unbind: g }))
  var _e = tinymce.util.Tools.resolve('tinymce.dom.DOMUtils'),
    ze = tinymce.util.Tools.resolve('tinymce.Env')
  const $e = (e, t) => {
      e.dispatch('FullscreenStateChanged', { state: t }),
        e.dispatch('ResizeEditor')
    },
    Ue = ('fullscreen_native', (e) => e.options.get('fullscreen_native'))
  const Ke = (e) => {
      return (
        e.dom ===
        (void 0 !== (t = z(e).dom).fullscreenElement
          ? t.fullscreenElement
    ...
    Ye = (e, t) =>
      ((e, n) => {
        return E(
          ((e) => b.from(e.dom.parentNode).map(B))((r = e))
            .map($)
            .map((e) =>
              E(e, (e) => {
    ...
    Ge = 'data-ephox-mobile-fullscreen-style',
    Je = 'position:absolute!important;',
    Qe =
    ...
    et = (e, t, n) => {
      const r = (t) => (n) => {
        ...
        i = ((e) => {
          ...
          return t
        })(S(o, (e) => Ye(e, '*:not(.tox-silver-sink)'))),
        a = ((e) => {
          const t = te(e, 'background-color')
          return void 0 !== t && '' !== t
    ...
    rt = (e, t) => {
      const n = document.body,
        ...
        o = e.getContainer(),
        s = B(o),
        i = ((l = s), b.from(l.dom.nextSibling).map(B)).filter(
          (e) =>
            ((e) => P(e) && L(e.dom))(e) &&
            ((e, t) =>
            ...
            ((e) => {
              const t = ((e, t) => {
                ...
                return (1 !== (r = n).nodeType &&
                  ...
                  ? []
                  : S(n.querySelectorAll(e), B)
                var r
              })('[' + Ge + ']')
              x(t, (t) => {
                const n = W(t, Ge)
                n && 'no-styles' !== n ? ee(t, e.parseStyle(n)) : q(t, 'style'),
                  q(t, Ge)
              })
            })(e.dom),
            p(tt.removeClass),
            nt.unbind(),
            b.from(t.get()).each((e) => e.fullscreenChangeHandler.unbind())
        }
      if (c)
        c.fullscreenChangeHandler.unbind(),
          ...
          w.isSome() && y.isSome()
            ? b.some(E(w.getOrDie(), y.getOrDie()))
            : b.none(),
          f(),
          (v = c.scrollPos),
        ...
        const n = ie(
          ...
          r = {
            ...
            sinkCssPosition: i.map((e) => te(e, 'position')),
          }
        d && et(e.dom, s, u),
