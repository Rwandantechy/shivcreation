...
!(function () {
  ...
  const Ie = (e) => e.length > 0,
    ...
    je = ['tfoot', 'thead', 'tbody', 'colgroup'],
    He = (e, t, o) => ({ element: e, rowspan: t, colspan: o }),
  ...
  const Ht = (e, t, o, l) => {
    ...
    $t = {
      ...
      property: d({
        ...
        isBoundary: (e) => !!Q(e) && ('body' === G(e) || D(jt, G(e))),
    ...
    zt = (e, t, o) =>
      ue(e, t).bind((t) =>
        ue(e, o).bind((e) => {
          ...
          ((e, t, o) =>
            o.length > 0
              ? ((e, t, o, l) => l(e, t, o[0], o.slice(1)))(e, t, o, Ht)
    ...
    to = (e, t) => {
      ...
      return Oe(o, l, (e, o) =>
        k(o, (o) => N(Ut(o.dom.cells), (o) => '1' === Te(o, t) || z(o, e))),
      ).getOr([])
    },
    oo = [
      { text: 'None', value: '' },
    ...
    yo = (e) =>
      e.length
        ? y.some(fo([{ text: 'Select...', value: 'mce-no-match' }, ...e]))
        : y.none(),
    wo = (e, t, o, l) =>
      M(t, (t) => {
        ...
        return ho(t)
          ? {
              type: 'nestedmenuitem',
              text: n,
              getSubmenuItems: () => wo(e, t.menu, o, l),
            }
          : {
              text: n,
              type: 'togglemenuitem',
    ...
    Co = (e) =>
      F(e, (e) =>
        ho(e) ? [{ ...e, menu: Co(e.menu) }] : Ie(e.value) ? [e] : [],
      ),
    vo = (e, t, o, l) => (n) => n(wo(e, t, o, l)),
    To = (e, t, o) => {
      const l = M(t, (e) => {
        return {
          text: e.title,
    ...
    Ro = [
      ...
      { name: 'valign', type: 'listbox', label: 'Vertical align', items: oo },
    ],
    Oo = (e) =>
      Ro.concat(
        ((e) =>
    ...
    No = ee('th'),
    Io = (e, t) => (e && t ? 'sectionCells' : e ? 'section' : 'cells'),
    Mo = (e) => {
      const t = M(
          e,
          (e) =>
    ...
    Po = (e, t) => j(e.all, (e) => B(e.cells, (e) => z(t, e.element))),
    ko = (e, t, o) => {
      const l = ((e) => {
        const t = [],
          o = (e) => {
    ...
    Eo = (e, t) => ko(e, t, f),
    Bo = (e, t) =>
      q(t, (t) => ((e, t) => Po(e, t).exists((e) => !e.isLocked))(e, t)),
    Fo = (e, t) => ((e, t) => t.mergable)(0, t).filter((t) => Bo(e, t.cells)),
    qo = (e, t) => ((e, t) => t.unmergable)(0, t).filter((t) => Bo(e, t)),
    Lo =
      (((e) => {
    ...
    Ho = (e) => {
      ...
      return {
        ...
        bordercolor: Be(t, 'border-color').map(jo).getOr(''),
        backgroundcolor: Be(t, 'background-color').map(jo).getOr(''),
      }
    },
    Vo = (e) => {
      const t = e[0],
    ...
    Wo = b($o, ['left', 'center', 'right'], 'align'),
    zo = b($o, ['top', 'middle', 'bottom'], 'valign'),
    Uo = (e) =>
      $e(V.fromDom(e))
        .map((t) => {
                ...
                ;(a || A(n, 'scope')) &&
                  ((e, t, o, l) => {
                    ...
                    P(t, (t) => {
                      ...
                      })(s, t.column.map((t) => Do(e, t)).getOr(s), o, a),
                        gt(e) &&
                          ((e, t, o) => {
                            o('backgroundcolor') &&
                              e.setFormat(
    ...
    Jo = (e) => {
      ...
      const o = ((e, t) => {
          ...
          return Vo(o.getOrDie())
        })(e, t),
        l = {
          type: 'tabpanel',
          tabs: [
            { title: 'General', name: 'general', items: Oo(e) },
            _o(e, 'cell'),
          ],
        },
        n = {
          type: 'panel',
          items: [{ type: 'grid', columns: 2, items: Oo(e) }],
        }
    ...
    Zo = (e) => {
      ...
      const o = M(t, (t) =>
        ...
        n = {
          type: 'tabpanel',
          tabs: [
            { title: 'General', name: 'general', items: Xo(e) },
            _o(e, 'row'),
          ],
        },
        r = {
          type: 'panel',
          items: [{ type: 'grid', columns: 2, items: Xo(e) }],
        }
      e.windowManager.open({
    ...
    tl = (e, t, o, n) => {
      if ('TD' === t.tagName || 'TH' === t.tagName)
        ...
        for (let l = 0; l < t.children.length; l++) tl(e, t.children[l], o, n)
    },
    ol = (e, t, o, l) => {
      const n = e.dom,
        r = l.getData(),
              ...
              if (
                ...
                c
                  ? (m
                      ...
                      : ((s['border-width'] = fe(o.border)), (r.border = 1)),
                ...
                if (
                  (m
                    ? (e['border-width'] = '')
                    : l.border && (e['border-width'] = fe(o.border)),
                  l.cellpadding && (e.padding = fe(o.cellpadding)),
    ...
    ll = (e, t) => {
          ...
          const o = Dt(e),
            ...
            n = t
              ? {
                  ...
                  bordercolor: jo(x(o, 'border-color').getOr('')),
                  backgroundcolor: jo(x(o, 'background-color').getOr('')),
                }
              : {}
          return {
            height: '',
                ...
                const l = e.dom,
                  n = St(e)
                    ...
                    : l.getAttrib(t, 'cellspacing') ||
                      l.getStyle(t, 'border-spacing'),
                  r = St(e)
                    ? tt(l, t, 'padding') || l.getAttrib(t, 'cellpadding')
                    : l.getAttrib(t, 'cellpadding') || tt(l, t, 'padding')
                return {
      ...
      const a = { type: 'grid', columns: 2, items: el(e, r.getOr([]), t) },
        s = ft(e)
          ? {
              type: 'tabpanel',
              tabs: [
    ...
    nl = (e) => {
      C(
        {
          mceTableProps: b(ll, e, !1),
          mceTableRowProps: b(Zo, e),
          mceTableCellProps: b(Jo, e),
          mceInsertTableDialog: b(ll, e, !0),
        },
        (t, o) =>
          e.addCommand(o, () => {
            return (
      ...
      const n = ee('caption'),
        ...
        a = () =>
          Yt(ye(e), he(e)).bind((t) => {
            return (
              (o = Oe(
                $e(t),
                Yt(((e) => V.fromDom(e.selection.getEnd()))(e), he(e)).bind($e),
                (o, l) =>
                  z(o, l)
                    ? n(t)
                      ? y.some(
        ...
        s = (e) =>
          $e(e.element).map((t) => {
            ...
            return {
              mergeable: Fo(o, e).isSome(),
              unmergeable: qo(o, e).isSome(),
              locked: n,
            }
          }),
        c = () => {
      ...
      return (
        e.on('NodeChange ExecCommand TableSelectorChange', c),
        {
          ...
          onSetupTableWithCaption: (t) =>
            d(t, h, (t) =>
              $e(t.element, he(e)).exists((e) => de(e, 'caption').isSome()),
            ),
  ...
  const ml = 'x-tinymce/dom-table-',
    ...
    pl = (e) => {
      var t
      const o = null !== (t = il.read()) && void 0 !== t ? t : []
  ...
  e.add('table', (e) => {
    ...
    ;((e) => {
      ...
      t('table_border_widths', { processor: 'object[]', default: st }),
        t('table_border_styles', { processor: 'object[]', default: ct }),
        ...
        0 !== u.length &&
          ...
          e.queryCommandSupported('mceTableApplyCellStyle') &&
            (e.ui.registry.addNestedMenuItem('tablecellvalign', {
              ...
              text: 'Vertical align',
              getSubmenuItems: () =>
                wo(e, oo, 'tablecellverticalalign', So(e, 'vertical-align')),
              onSetup: t.onSetupCellOrRow,
            }),
            e.ui.registry.addNestedMenuItem('tablecellborderwidth', {
              ...
              text: 'Border width',
              getSubmenuItems: () =>
                wo(e, pt(e), 'tablecellborderwidth', So(e, 'border-width')),
              onSetup: t.onSetupCellOrRow,
            }),
            e.ui.registry.addNestedMenuItem('tablecellborderstyle', {
              ...
              text: 'Border style',
              getSubmenuItems: () =>
                wo(e, bt(e), 'tablecellborderstyle', So(e, 'border-style')),
              onSetup: t.onSetupCellOrRow,
            }),
            e.ui.registry.addNestedMenuItem('tablecellbackgroundcolor', {
              icon: 'cell-background-color',
              text: 'Background color',
              getSubmenuItems: () => To(e, At(e), 'background-color'),
              onSetup: t.onSetupCellOrRow,
            }),
            e.ui.registry.addNestedMenuItem('tablecellbordercolor', {
              icon: 'cell-border-color',
              text: 'Border color',
              getSubmenuItems: () => To(e, Rt(e), 'border-color'),
              onSetup: t.onSetupCellOrRow,
            })),
          n('tablecaption', {
            icon: 'table-caption',
        ...
        0 !== a.length &&
          ...
          e.queryCommandSupported('mceTableApplyCellStyle') &&
            ...
            e.ui.registry.addMenuButton('tablecellbackgroundcolor', {
              ...
              fetch: (t) => t(To(e, At(e), 'background-color')),
              onSetup: t.onSetupCellOrRow,
            }),
            e.ui.registry.addMenuButton('tablecellbordercolor', {
              icon: 'cell-border-color',
              tooltip: 'Border color',
              fetch: (t) => t(To(e, Rt(e), 'border-color')),
              onSetup: t.onSetupCellOrRow,
            })),
          n('tablecaption', {
