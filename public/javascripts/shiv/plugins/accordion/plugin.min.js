...
!(function () {
  ...
  var L
  const $ = (e) => void 0 !== e.style && i(e.style.getPropertyValue),
    I = (e) => (A(e) ? e : P.fromDom(e.dom.ownerDocument)),
    V = (e) => u.from(e.dom.parentNode).map(P.fromDom),
    j = (e) => u.from(e.dom.nextSibling).map(P.fromDom),
    q = (e) => h(e.dom.childNodes, P.fromDom),
    F =
      i(Element.prototype.attachShadow) && i(Node.prototype.getRootNode)
        ? (e) => P.fromDom(e.dom.getRootNode())
        : I,
    H = (e) => P.fromDom(e.dom.host),
    z = (e) => {
      ...
      return ((e) => {
        const t = F(e)
        return C((o = t)) && a(o.dom.host) ? u.some(t) : u.none()
        var o
      })(P.fromDom(t)).fold(
        () => o.body.contains(t),
        ((n = z), (r = H), (e) => n(r(e))),
    ...
    K = (e, t) => ($(e) ? e.style.getPropertyValue(t) : ''),
    U = (e, t) => {
      V(e).each((o) => {
    ...
    J = (e, t) => {
      ...
      return (
        f(q(e), (e) => {
          t(e) && (o = o.concat([e])), (o = o.concat(J(e, t)))
        }),
        o
      )
    },
  ...
  const oe = (e, t) => ({ element: e, offset: t }),
    ...
    se = (e, t) => {
      const o = ne(e, t, e.query().prevSibling).getOr(t)
      if (e.property().isText(o)) return oe(o, re(e, o))
      const n = e.property().children(o)
      return n.length > 0 ? se(e, n[n.length - 1]) : oe(o, re(e, o))
    },
    ae = se,
    ie = {
      up: l({
      ...
      property: l({
        ...
        getLanguage: (e) => (N(e) ? E(e, 'lang') : u.none()),
        getText: (e) => ee.get(e),
        setText: (e, t) => ee.set(e, t),
        isBoundary: (e) => !!N(e) && ('body' === v(e) || p(te, v(e))),
    ...
    de = 'details',
    le = 'mce-accordion',
    ce = 'mce-accordion-summary',
    me = 'mce-accordion-body',
    ue = 'div'
  var ge = tinymce.util.Tools.resolve('tinymce.util.Tools')
  const pe = (e) => 'SUMMARY' === (null == e ? void 0 : e.nodeName),
    he = (e) => 'DETAILS' === (null == e ? void 0 : e.nodeName),
    fe = (e) => e.hasAttribute('open'),
    ye = (e) => {
      const t = e.selection.getNode()
      return pe(t) || Boolean(e.dom.getParent(t, pe))
    },
    ve = (e) => !ye(e) && e.dom.isEditable(e.selection.getNode()),
    we = (e) => u.from(e.dom.getParent(e.selection.getNode(), he)),
    be = (e) => ((e.innerHTML = '<br data-mce-bogus="1" />'), e),
    Ne = (e) => be(e.dom.create('p')),
    Te = (e) => (t) => {
      ;((e, t) => {
        if (pe(null == t ? void 0 : t.lastChild)) {
          const o = Ne(e)
          t.appendChild(o), e.selection.setCursorLocation(o, 0)
        }
      })(e, t),
        ((e, t) => {
          if (!pe(null == t ? void 0 : t.firstChild)) {
            const o = ((e) => be(e.dom.create('summary')))(e)
            t.prepend(o), e.selection.setCursorLocation(o, 0)
          }
        })(e, t)
    },
    Ae = (e, t) => {
      const o = null != t ? t : !fe(e)
      return o ? e.setAttribute('open', 'open') : e.removeAttribute('open'), o
    },
    Ce = (e) => {
      e.addCommand('InsertAccordion', () =>
        ((e) => {
          if (!ve(e)) return
          const o = P.fromDom(e.getBody()),
            n = ((e) => {
              ...
              return t++, 'acc_' + n + t + String(o)
            })(),
            r = e.dom.encode(
              e.selection.getRng().toString() ||
                e.translate('Accordion summary...'),
            ),
            s = e.dom.encode(e.translate('Accordion body...')),
            a = `<summary class="${ce}">${r}</summary>`,
            i = `<${ue} class="${me}"><p>${s}</p></${ue}>`
          e.undoManager.transact(() => {
            e.insertContent(
              [
                `<details data-mce-id="${n}" class="${le}" open="open">`,
                a,
                i,
                '</details>',
              ].join(''),
            ),
              Z(o, `[data-mce-id="${n}"]`).each((t) => {
                D(t, 'data-mce-id'),
                  Z(t, 'summary').each((t) => {
  ...
  var Se = tinymce.util.Tools.resolve('tinymce.html.Node')
  const xe = (e) => {
      var t, o
      return null !==
        (o =
  ...
  const Be = (e) => {
    ;((e) => {
      e.on('keydown', (t) => {
        ;((!t.shiftKey && t.keyCode === ke.ENTER && ye(e)) ||
          ((e) => {
      ...
      e.on('ExecCommand', (t) => {
        ...
        ;('delete' !== o && 'forwarddelete' !== o) ||
          !((e) => we(e).isSome())(e) ||
          ((e) => {
            ge.each(ge.grep(e.dom.select('details', e.getBody())), Te(e))
          })(e)
      })
  }
  var Re = tinymce.util.Tools.resolve('tinymce.Env')
  const Le = (e) => (t) => {
    ...
    ;((e) => {
      ...
      ((e) => {
        e.on('PreInit', () => {
          ...
          o.addNodeFilter(de, (e) => {
            for (let t = 0; t < e.length; t++) {
              const o = e[t]
              if (Me(o)) {
                const e = o,
                  { summaryNode: t, wrapperNode: n, otherNodes: r } = Pe(e),
                  i = a(t),
                  d = i ? t : new Se('summary', 1)
                s(d.firstChild) && Oe(d),
                  Ee(d, [ce]),
                  i ||
                    (a(e.firstChild)
                ...
                const l = a(n),
                  c = l ? n : new Se(ue, 1)
                if ((c.attr('data-mce-bogus', '1'), Ee(c, [me]), r.length > 0))
            ...
            t.addNodeFilter(de, (e) => {
              const t = new Set([ce])
              for (let o = 0; o < e.length; o++) {
                const n = e[o]
                if (Me(n)) {
                  const e = n,
                    { summaryNode: o, wrapperNode: r } = Pe(e)
                  a(o) && De(o, t), a(r) && r.unwrap()
                }
              }
            })
        })
