...
!(function () {
  ...
  const ft = (e, t, o) => {
    ...
    qt = (e) => Ht(e, 'th,td'),
    Ut = (e) =>
      Ce(e, 'colgroup') ? mt(e, 'col') : j(Yt(e), (e) => mt(e, 'col')),
    Gt = (e, t) => wt(e, 'table', t),
    Kt = (e) => Ht(e, 'tr'),
    ...
    lo = [
      ...
      },
      {
        ...
        search: (e) =>
          (St(e, 'safari') || St(e, 'mobile/')) && St(e, 'applewebkit'),
      },
    ],
    ao = [
      {
  ...
  const No = () => Eo(),
    ...
    Yn = (e) =>
      Pn(e) ? gn(e) : ((e, t, o) => o(e) / Mt(e, 'rowspan'))(e, 0, Vn),
    Jn = (e, t, o) => {
      Nt(e, 'width', t + o)
    },
    Qn = (e) => In(e, Ao, Wo) + '%',
    ...
    nr = (e, t, o, n) => {
      const r = an(e),
        ...
        l = [C.some(zn.edge(t))].concat(
          E(zn.positions(r, t), (e) => e.map((e) => e.x)),
        ),
        a = w(jt)
      return E(s, (e, t) =>
        or(
    ...
    lr = (e, t, o, n) => {
      const r = mn(e),
        ...
        l = [C.some(Bn.edge(t))].concat(
          E(Bn.positions(r, t), (e) => e.map((e) => e.y)),
        )
  ...
  const vs = (e, t, o, n) => {
    ...
    Cs = (e, t) =>
      ((e, t, o) =>
        o.length > 0
          ? ((e, t, o, n) => n(e, t, o[0], o.slice(1)))(e, t, o, vs)
          : C.none())(xs, (t, o) => e(o), t),
    Ss = (e) => ht(e, 'table'),
    Ts = (e, t, o) => {
      ...
      return Re(e, t)
        ...
        : Ss(e).bind((r) =>
            Ss(t).bind((s) => {
              if (Re(r, s))
                return C.some({ boxes: gs(r, e, t), start: e, finish: t })
              if (De(r, s)) {
    ...
    Ds = (e, t, o) =>
      bt(e, t).bind((t) =>
        bt(e, o).bind((e) =>
          Cs(Ss, [t, e]).map((o) => ({ first: t, last: e, table: o })),
        ),
      ),
    Os = (e, t, o, n, r) =>
    ...
    Bs = (e) => {
      ...
      return e.length > 0 && P(e, (e) => t(e, 'rowspan') || t(e, 'colspan'))
        ? C.some(e)
        : C.none()
    },
    _s = (e, t, o) =>
    ...
    gl = () => ({
      transformRow: (e, t) => dl(e, 'thead' === t ? 'tbody' : t),
      transformCell: ml,
    }),
    hl = ul,
    pl = fl,
    ...
    xl = (e, t) => {
      const o = [],
        ...
        s = (e) =>
          j(e, (e) =>
            E(e.cells, (e) => (vl(e.element, 'span', e.colspan, 1), e.element)),
          ),
        l = (t, o) => {
          const n = ((e, t) => {
          ...
          if (!1 === o[r][s]) {
            const m = ((e, t, o, n) => {
              const r = ((e, t) => e[t])(e, t),
                ...
                a = s
                  ? 1
                  : Cl(((e, t) => E(e, (e) => Fo(e, t)))(e.slice(t), o), n)
    ...
    _l = (e, t) =>
      P(t, (t) => ((e, t) => Dl(e, t).exists((e) => !e.isLocked))(e, t)),
    zl = (e, t, o, n) => {
      const r = Vo(e).rows
      let s = !0
    ...
    Yl = (e, t, o, n) =>
      ((e, t, o, n) =>
        void 0 !== Ho(e[t], o) && t > 0 && n(Ho(e[t - 1], o), Ho(e[t], o)))(
        e,
        t,
        o,
        n,
    ...
    Jl = (e, t, o, n) => {
      const r = (e) =>
        ((e) => ('row' === e ? ((e) => Mt(e, 'rowspan') > 1)(t) : jt(t)))(e)
          ? `${e}group`
          : e
      return e
        ? sl(t)
    ...
    la = (e, t, o) => {
      const n = Xo(e),
        ...
        l = ((e, t) =>
          E(e.all, (e, o) => ({ element: e.element, height: t[o] })))(n, s)
      N(l, (e) => {
    ...
    fa = (e, t = da) => {
      const o = (o) => {
        if (ma(o))
          return ia((r = { element: o }).element) ? e.colgroup(r) : e.row(r)
        {
          const r = o,
      ...
      const t = ue('br'),
        ...
        n = (() => {
          const n = j(e, (e) => {
            const n = Le(e)
            return ((e) =>
              P(e, (e) => t(e) || (ie(e) && 0 === hr(e).trim().length)))(n)
              ? []
              : n.concat(o(e))
          })
        ...
        return ((e, t, o, n, r) => {
          const s = Ko(t),
            l = ((e, t, o) => {
              ...
              return {
                row: r,
                column: L(s, (e) => P(o, (t) => t !== e)).getOr(n - 1),
              }
            })(e, t, s),
            a = Vo(o).rows,
            c = Vl(l, a, s),
      ...
      return Nl(o, t)
        .bind((e) => {
          const t = e[e.length - 1],
            ...
            s = M(
              E(o.all, (e) => _(e.cells, (e) => e.column >= n && e.column < r)),
            )
          return il(s)
        })
        .getOr('')
    ...
    Sc = (e, t) =>
      0 === e.length ? t : z(e, (e, t) => xc.from(t).fold(g(0), h, h) + e, 0),
    Tc = (e, t) =>
      xc.from(e).fold(
        g(e),
        (e) => e + t + 'px',
    ...
    Rc = (e) => {
      ...
      return o
        .slice(0, o.length - 1)
        .concat([Tc(o[o.length - 1], Math.round(t.remainder))])
    },
    Dc = xc.from,
    Oc = (e, t, o) => {
      const n = Xo(e),
  ...
  const Ic = 'x-tinymce/dom-table-',
    ...
    Zc = (e, t) => {
      const o = es(e),
        n = (e) => Gt(e, o),
        l = (t) =>
          ((e) => Fs(os(e), es(e)).filter(cs))(e).bind((e) =>
            n(e).map((o) => t(o, e)),
          ),
        a = (t) => {
          e.focus()
                  ...
                  E(e, (e) => {
                    ...
                    return (
                      N(e.cells, (e) => {
                        ...
                        vl(o, 'colspan', e.colspan, 1),
                          vl(o, 'rowspan', e.rowspan, 1),
                          Ie(t, o)
                      }),
                      t
                    )
        ...
        g = (e) => (t, o) =>
          ((e, t) => (X(e, t) ? C.from(e[t]) : C.none()))(o, 'type').each(
            (t) => {
              c(e(t), o.no_events)
            },
          )
  ...
  const fi = (e, t, o, n) => ({ start: e, soffset: t, finish: o, foffset: n }),
        ...
        : Ts(o, n, t).bind((t) => {
            ...
            return n.length > 1
              ? (r(e, n, t.start, t.finish),
                C.some(oi(C.some(pi(o, 0, o, wr(o))), !0)))
              : C.none()
          }),
    ...
    Si = (e, t, o, n, r = Ci) =>
      L(r, (e) => e.current === o).bind((o) =>
        o
          ...
          .orThunk(() => o.fallback.bind((o) => Si(e, t, o, n))),
      ),
    Ti = (e, t, o, n, r, s) =>
      Si(e, t, n, r).bind((t) =>
        s(t.item)
    ...
    Li = (e, t, o) =>
      t(e, o).bind((e) =>
        ie(e) && 0 === hr(e).trim().length ? Li(e, t, o) : C.some(e),
      ),
    Wi = (e, t, o, n) =>
      ((e, t) =>
        We(e, t)
    ...
    $i = (e, t) =>
      ce(t)
        ? Fi(e, t).map(Ii)
        : ie(t)
          ? e.getRangedRect(t, 0, t, wr(t)).map(Ii)
          : C.none(),
    ...
    Xi = (e, t, o, n, r) =>
      Hi(e, t, o).bind((t) => Zi(e, r, n(t, Yi.getJumpSize()))),
    Zi = (e, t, o) => {
      const n = No().browser
    ...
    tm = (e, t, o, n, r) =>
      wt(n, 'td,th', t).bind((n) =>
        wt(n, 'table', t).bind((s) =>
          ((e, t) =>
            ft(e, (e) => Ne(e).exists((e) => Re(e, t)), void 0).isSome())(r, s)
            ? ((e, t, o) =>
                Ji(e, t, o).bind((n) =>
                  Qi(e, t, n.element, n.offset, o, 20).map(e.fromSitus),
                ))(e, t, o).bind((e) =>
                wt(e.finish, 'td,th', t).map((t) => ({
                  start: n,
                  finish: t,
                  range: e,
                })),
    ...
    nm = (e, t) =>
      wt(e, 'tr', t).bind((e) =>
        wt(e, 'table', t).bind((o) => {
          const n = dt(o, 'tr')
          return Re(e, n[0])
            ? ((e, t, o) => Di(ki, e, (e) => Cr(e).isSome(), o))(o, 0, t).map(
                (e) => {
                  const t = wr(e)
      ...
      wt(e, 'tr', t).bind((e) =>
        wt(e, 'table', t).bind((o) => {
          ...
          return Re(e, n[n.length - 1])
            ? ((e, t, o) => Oi(ki, e, (e) => xr(e).isSome(), o))(o, 0, t).map(
                (e) => oi(C.some(pi(e, 0, e, 0)), !0),
              )
            : C.none()
        }),
      ),
    sm = (e, t, o, n, r, s, l) =>
      tm(e, o, n, r, s).bind((e) => bi(t, o, e.start, e.finish, l)),
    lm = (e) => {
      let t = e
      return {
        get: () => t,
    ...
    Bm = (e) =>
      ((e) =>
        Cm(e)
          ...
          .bind(Em))(e).map((e) =>
        vm.exact(e.start, e.soffset, e.finish, e.foffset),
      ),
    _m = (e) => ({
      ...
      situsFromPoint: (t, o) =>
        ((e, t, o) =>
          ...
          gi(e.start, e.soffset, e.finish, e.foffset),
        ),
      clearSelection: () => {
        ;((e) => {
    ...
    Ym = (e, t) => {
      const o =
          ...
          {
            get: () =>
              ks(xe.fromDom(e.getBody()), r).fold(
                () => Fs(os(e), es(e)).fold(Im, Hm),
                Fm,
              ),
          }),
        n = ((e, t, o) => {
      ...
      return (
                          ...
                          return s.fold(
                            () =>
                              Ds(
                                ...
                                const o =
                                  gm(u) || m.isForward(u) ? ti.after : ti.before
                                return (
        ...
        e.on('PreInit', () => {
          e.serializer.addTempAttr(Ms.firstSelected),
            e.serializer.addTempAttr(Ms.lastSelected)
        }),
        {
          getSelectedCells: () =>
            ((e, t, o, n) => {
      ...
      return (
        e.on('init', () => {
          const r = ((e, t) =>
            e.inline
              ...
              : ((e, t) => {
                  const o = me(e)
                    ? ((e) => xe.fromDom(Ee(e).dom.documentElement))(e)
                    : e
                  return {
                    parent: g(o),
                    view: g(e),
        ...
        e.on('ObjectResized', (t) => {
          ...
          if (xd(o)) {
            const n = xe.fromDom(o),
              r = t.origin
            ;((e) => Tt(e, 'corner-'))(r) && m(n, r, t.width, t.height),
              ts(n),
              dc(e, n.dom, uc)
          }
        }),
